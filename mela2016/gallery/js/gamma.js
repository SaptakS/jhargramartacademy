	...
	var $window = $( window ),
		...
		_singleviewitem = function( $item, anim ) {
			...
			var	finalConfig = _getFinalImgConfig( {
				...
				source = finalConfig.source,
				finalSizePosition = finalConfig.finalSizePosition;
				//console.log( "sdflnsf" + finalSizePosition+ " " + Gamma.svMargins.horizontal + " " + Gamma.svMargins.vertical);
			Gamma.current = id;
			...
			setTimeout( function() {
				...
				if( !anim ) {
					...
					var styleCSS = {
						...
						console.log(Gamma.svMargins.horizontal + " " + Gamma.svMargins.vertical);
