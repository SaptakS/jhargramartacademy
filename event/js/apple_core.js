...
};String.prototype.lastPathComponent=function(){var b=this.lastIndexOf("http://www.apple.com/");if(b!=-1){return this.substring(b+1,this.length-1)
}else{return null}};String.prototype.stringByDeletingLastPathComponent=function(){var b=this.lastIndexOf("http://www.apple.com/");
if(b!=-1){return this.slice(0,b)}else{return null}};String.prototype.stringByAppendingPathComponent=function(b){return(this.lastIndexOf("http://www.apple.com/")!==(this.length-1))?(this+"/"+b):(this+b)
